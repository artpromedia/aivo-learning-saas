          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3.5 top-1/2 -translate-y-1/2 transition-colors hover:opacity-70" style={{ color: "var(--aivo-text-muted)" }} aria-label={showPassword ? t("hidePassword") : t("showPassword")}>
