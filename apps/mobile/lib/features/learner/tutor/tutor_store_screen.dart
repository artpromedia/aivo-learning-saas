  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: catalogAsync.when(
        loading: () => LoadingShimmer.list(itemCount: 6),
        error: (e, _) => ErrorView.fullScreen(
          message: 'Failed to load tutor catalog.\n$e',
          onRetry: () => ref.invalidate(_tutorCatalogProvider),
        ),
        data: (tutors) {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: tutor.isSubscribed
                        ...
                        : ElevatedButton(
                            onPressed:
                                isLoading ? null : () => _subscribe(context, ref),
