  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* TODO: Feature card titles and descriptions need translation keys in a future sprint */}
