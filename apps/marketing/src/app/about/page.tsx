...
const team: TeamMember[] = [
  {
    ...
    image: "/team/osuji.png",
    bio: "Ikechukwu Osuji, MD, MPH, is a distinguished Internal Medicine physician and healthcare executive with over 35 years of global experience. He completed his Internal Medicine residency at Howard University \u2014 graduating top of his class \u2014 and earned a Master of Public Health from George Washington University specializing in International Health. Ike's career spans both clinical and executive leadership. He served as Chief of Staff at two U.S. hospitals and spent roughly a decade as Medical Director of Ernest Health International, overseeing the operations and clinical excellence of 26 hospitals nationwide. As an entrepreneur, he founded a private Internal Medicine practice that he grew into five locations before its successful acquisition by WellMed (UnitedHealth Group) in 2024. Ike brings deep expertise in clinical operations, healthcare governance, and scaling medical organizations to AIVO's mission of ensuring no learner is left behind.",
  ...
  },
  {
    ...
    image: "/team/ofem.png",
    bio: "Ofem Ofem is a business executive with nearly two decades of experience in workforce development, human capital strategy, and organizational leadership. He has led large-scale strategy engagements for multinational corporations and government agencies across West Africa, and created a workforce development methodology adopted by 15 major corporations and recognized by the Nigerian federal government as a foundation for national youth employment policy. He served as Managing Director of SmartCity Lagos, a $10 billion smart-city initiative assessed by PwC as one of the largest single foreign direct investments in Nigerian history. A published scholar with peer-reviewed articles in Human Resource Development Review and AI & Society, Ofem is completing his Doctor of Business Administration at Saint Mary's University of Minnesota with a focus on AI governance and organizational decision-making.",
    linkedin: "https://www.linkedin.com/in/ofem-ofem",
  },
  {
    name: "Nnamdi Uzokwe",
    role: "Co-Founder & Chief Commercial Officer",
    image: "/team/Nnamdi.jpg",
  ...
  },
  {
    ...
    bio: "Edward Hamilton is a veteran of the NYPD 911 system and a dedicated special education advocate. His years of frontline public service instilled a profound commitment to protecting and uplifting vulnerable communities \u2014 a mission he now carries into the education technology space. Edward bridges the gap between families navigating the complex special education system and the technology that can transform their children's outcomes. As VP of Special Education & Sales, he leads AIVO's outreach to school districts, therapy practices, and parent communities, ensuring the platform reaches the families who need it most.",
    linkedin: "https://www.linkedin.com/",
  },
  {
