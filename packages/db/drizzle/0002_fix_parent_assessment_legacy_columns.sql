...
DO $$ BEGIN
  IF EXISTS (
    ...
    WHERE table_name = 'parent_assessments' AND column_name = 'district_id'
  ) THEN
...
DO $$ BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'parent_assessments' AND column_name = 'child_id'
  ) THEN
...
DO $$ BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'parent_assessments' AND column_name = 'status'
  ) THEN
...
DO $$ BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'parent_assessments' AND column_name = 'assessment_mode'
  ) THEN
...
DO $$ BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'parent_assessments' AND column_name = 'has_iep'
  ) THEN
...
DO $$ BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'parent_assessments' AND column_name = 'has_504'
  ) THEN
...
DO $$ BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'parent_assessments' AND column_name = 'has_other_disability'
  ) THEN
...
DO $$ BEGIN
  IF EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_name = 'parent_assessments' AND column_name = 'preferred_language'
  ) THEN
